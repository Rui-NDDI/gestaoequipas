...
class __TwigTemplate_3670e1ec95ce23f531fdba5cc1e91d76 extends Template
{
...
($context["fields"] ?? null)) && is_array($_v0) || $_v0 instanceof ArrayAccess && in_array($_v0::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v0[(($_v1 = $context["key"]) instanceof \Stringable ? (string) $_v1 : $_v1)] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["fields"] ?? null), $context["key"], [], "array", false, false, true, 92)))];
                    // line 95
                    yield "          ";
                }
                // line 96
      ...
      ";
          ...
          ";
                ...
                foreach ($context['_seq'] as $context["key"] => $context["column"]) {
                    // line 168
                    yield "            ";
                    if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (($_v2 = ($context["subtotals"] ?? null)) && is_array($_v2) || $_v2 instanceof ArrayAccess && in_array($_v2::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v2[(($_v3 = ($context["row_number"] ?? null)) instanceof \Stringable ? (string) $_v3 : $_v3)] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["subtotals"] ?? null), ($context["row_number"] ?? null), [], "array", false, false, true, 168)), $context["key"], [], "any", false, false, true, 168)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 169
                        yield "              ";
                        if (((($context["grouping_field"] ?? null) && ($context["grouping_field_class"] ?? null)) && (($context["grouping_field"] ?? null) == $context["key"]))) {
                            // line 170
                            ...
                            yield ">";
                            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, (($_v4 = ($context["subtotals"] ?? null)) && is_array($_v4) || $_v4 instanceof ArrayAccess && in_array($_v4::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v4[(($_v5 = ($context["row_number"] ?? null)) instanceof \Stringable ? (string) $_v5 : $_v5)] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["subtotals"] ?? null), ($context["row_number"] ?? null), [], "array", false, false, true, 170)), $context["key"], [], "any", false, false, true, 170), "html", null, true);
                            yield "</td>
              ";
                        } else {
                            // line 172
                            ...
                            yield ">";
                            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, (($_v6 = ($context["subtotals"] ?? null)) && is_array($_v6) || $_v6 instanceof ArrayAccess && in_array($_v6::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v6[(($_v7 = ($context["row_number"] ?? null)) instanceof \Stringable ? (string) $_v7 : $_v7)] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["subtotals"] ?? null), ($context["row_number"] ?? null), [], "array", false, false, true, 172)), $context["key"], [], "any", false, false, true, 172), "html", null, true);
                            yield "</td>
              ";
                        }
                        // line 174
